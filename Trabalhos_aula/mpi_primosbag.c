...
//cd ~/lab-paralela
//mpicc mpi_primosbag.c -o mpi_primosbag -lm
//mpiexec -n 4 ./mpi_primosbag 10
//com 1 tem que dar 0 e negativo também tem que dar 0
//verirfica se tem trabalho pra todo mundo se não tiver corrigir a alocação inicial caso nao haja para todos processos
//corrigir o else apra que antes de testar o estado ele tem que ter recebido alguma coisa (não pode começar testando uma coisa que não recebeu)
//alguma coisa sobre time 99